...
const AVAILABLE_DISTRICTS = [
  'центр', 'патриаршие', 'арбат', 'хамовники', 'замоскворечье',
  'таганка', 'покровка', 'чистые пруды', 'басманный', 'китай-город',
  'пресня', 'сокольники', 'кузнецкий мост', 'марьина роща', 'бауманская',
  'дорогомилово', 'лефортово', 'коломенское', 'измайлово', 'митино',
]
